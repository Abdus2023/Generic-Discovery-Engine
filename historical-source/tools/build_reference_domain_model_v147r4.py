...
def main():
    if any((COMPLIANCE / f"certification/v14.7-{successor}").exists() for successor in ("R5", "R6")):
        raise RuntimeError("refusing to rewrite predecessor after append-only v14.7-R5/R6 realization")

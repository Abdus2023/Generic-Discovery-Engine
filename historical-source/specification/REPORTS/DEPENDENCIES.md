# v11.1 Requirement Dependencies
...
The requirement graph has zero nodes and edges. Obligation dependencies and lineage remain separate and are not copied into requirement dependencies.

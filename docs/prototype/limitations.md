...
```
claim_kind:           CURRENT
implementation_state: NOT_IMPLEMENTED for every protection listed as absent · PARTIAL where a
                      defect limits a partially working mechanism
...
Nothing here describes a protection that does not exist.

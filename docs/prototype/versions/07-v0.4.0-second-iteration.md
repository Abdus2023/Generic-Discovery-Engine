# v0.4.0 — Second Iteration

> **Status:** UNVERIFIED
>
> **Source:** `Continue Architecture Planning.md`
>
> **Purpose:** A second complete v0.4.0 produced later in the conversation.
...
- *Turn lead-in* — `CAP-016` — `Continue Architecture Planning.md` L13484–18265
...
<!-- CAP-016 | Continue Architecture Planning.md L13484–18265 | turn 11 -->
> **Source sections:** `CAP-016`
>
...
Below is the complete **v0.4.0** userscript, continuing from v0.3.0 and adding network observation, performance-resource discovery, depth-aware scheduling, retry backoff, sitemap/robots/manifest discovery, CSS/JS/XML handling, richer provenance, and a graph-oriented export.

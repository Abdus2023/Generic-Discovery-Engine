# v0.2.0 — Providers and Atomic Claiming

> **Status:** UNVERIFIED
>
> **Source:** `Userscript Discovery Prototype.md`
>
> **Purpose:** Adds explicit concurrent candidate claiming, HTML/JSON/text providers and an explicit scope.

> **Duplicate note.** The planning conversation contains a flattened paste of
> this script (`00-v0.1.0-and-v0.2.0-paste.md`) in which the userscript
> `@match` directive survives as `*://*/*`; in this copy it appears as
> `_://_/*`. The difference is recorded, not repaired. See
> [Review Notes](../../REVIEW-NOTES.md#duplicates).
...
- *Turn lead-in* — `USP-069` — `Userscript Discovery Prototype.md` L3031–3033
- *Turn lead-in* — `USP-070` — `Userscript Discovery Prototype.md` L3039–4711
...
<!-- USP-069 | Userscript Discovery Prototype.md L3031–3033 | turn 14 -->
> **Source sections:** `USP-069`, `CAP-001`
>
> [DOCUMENTATION REVIEW] **D-02** ([Review Notes](../../REVIEW-NOTES.md#d-02--))
>
...
<!-- USP-070 | Userscript Discovery Prototype.md L3039–4711 | turn 15 -->
> **Source sections:** `USP-070`, `CAP-001`
>
> [DOCUMENTATION REVIEW] **D-02** ([Review Notes](../../REVIEW-NOTES.md#d-02--))
>

...
- *Turn lead-in* — `Continue Architecture Planning.md` L44–44
- *Turn lead-in* — `Continue Architecture Planning.md` L50–2645
...
<!-- source: Continue Architecture Planning.md L44–44 | turn 2 -->
Take v0.2.0 and return a complete corrected v0.3.0 userscript

<!-- source: Continue Architecture Planning.md L50–2645 | turn 3 -->

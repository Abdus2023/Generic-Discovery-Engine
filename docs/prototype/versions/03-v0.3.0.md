# v0.3.0 — Corrected URL Resolution

> **Status:** UNVERIFIED
>
> **Source:** `Continue Architecture Planning.md`
>
> **Purpose:** Corrections to URL resolution, discovery model, timeouts, retries and persistence.
...
- *Turn lead-in* — `CAP-003` — `Continue Architecture Planning.md` L44–44
- *Turn lead-in* — `CAP-004` — `Continue Architecture Planning.md` L50–2645
...
<!-- CAP-003 | Continue Architecture Planning.md L44–44 | turn 2 -->
> **Source sections:** `CAP-003`
>
> **Note:** lead-in of the following section; the source presents this as the delivered prototype; no implementation file in this repository verifies it

Take v0.2.0 and return a complete corrected v0.3.0 userscript

<!-- CAP-004 | Continue Architecture Planning.md L50–2645 | turn 3 -->
> **Source sections:** `CAP-004`
>
> **Note:** the source presents this as the delivered prototype; no implementation file in this repository verifies it

Below is a cleaned-up **v0.3.0** based on your v0.2.0. I kept the architecture intact, but fixed several practical issues: relative-URL resolution from fetched HTML, safer content-type handling, proper fetch timeouts, better resource extraction, retry support, bounded persistence, live UI statistics, and cleaner run-state handling.

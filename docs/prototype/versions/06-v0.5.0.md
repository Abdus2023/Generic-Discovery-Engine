# v0.5.0 — Resource Identity and Fingerprints

> **Status:** UNVERIFIED
>
> **Source:** `Continue Architecture Planning.md`
>
> **Purpose:** Adds an execution-world-safe network bridge, PerformanceObserver fallback and candidate fingerprints.
...
- *Turn lead-in* — `CAP-013` — `Continue Architecture Planning.md` L7160–13452
...
<!-- CAP-013 | Continue Architecture Planning.md L7160–13452 | turn 9 -->
> **Source sections:** `CAP-013`
>
...
Continuing with **v0.5.0**. This version focuses on making the discovery engine more robust rather than simply adding more URL extractors:

* **Execution-world-safe network bridge** for page `fetch`/XHR observation.
* **PerformanceObserver fallback** for resources the bridge misses.
* **Candidate fingerprints** to deduplicate the same resource across discovery mechanisms.
* **Provider scoring** instead of first-match provider selection.
* **HEAD/GET-aware acquisition hints**.
* **HTTP status classification** and redirect tracking.
* **robots.txt / sitemap discovery**.
* **OpenAPI/Swagger discovery**.
* **Graph edge provenance** for passive observations.
* **Pause/resume/stop controls**.
* **Run isolation** so stale asynchronous workers cannot mutate a later run.
* **Bounded response bodies** to prevent a huge resource from exhausting memory.
* **No persistence of complete JSON response bodies**.
* **Import/export of the discovery graph**.

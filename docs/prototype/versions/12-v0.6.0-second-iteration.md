# v0.6.0 — Second Iteration

> **Status:** CURRENT
>
> **Source:** `Continue Architecture Planning.md`
>
> **Purpose:** Policy/scheduler layer, adaptive concurrency and per-origin budgets.
...
- *Turn lead-in* — `CAP-030` — `Continue Architecture Planning.md` L34752–43127
...
<!-- CAP-030 | Continue Architecture Planning.md L34752–43127 | turn 21 -->
> **Source sections:** `CAP-030`

Continuing to **v0.6.0**. This version adds the policy/scheduler layer, adaptive concurrency, per-origin politeness, pause/resume/stop, tracking-parameter normalization, content-policy skips, duplicate-content detection, redirect relationships, and richer diagnostics.

# Security Audit — Generic Discovery Engine v0.8.2

**Scope:** `dist/generic-discovery-engine.user.js` (5,864 lines) + `src/` mirror 7 files, `dist/generic-discovery-engine.v0.7.1.user.js`, tests, configuration  
**Date:** 2026-09-12  

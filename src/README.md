...
`dist/generic-discovery-engine.user.js` (5,784 lines, sha256 031c3…) is still the runnable artifact, but its logical sections are now mirrored here as ES modules:
